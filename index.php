...
<body>
    ...
    <script src="<?= SITE_URL ?>/assets/js/app.js?v=3.2"></script>
    <script src="<?= SITE_URL ?>/assets/js/animations.js?v=3.2"></script>
    <script src="<?= SITE_URL ?>/assets/js/masonry-hover.js?v=3.2"></script>
    <?php if ($currentSlug === '' || $currentSlug === 'home'): ?>
    <script src="<?= SITE_URL ?>/assets/js/typed.js?v=3.2"></script>
    <script src="<?= SITE_URL ?>/assets/js/neural.js?v=3.2"></script>
    <script src="<?= SITE_URL ?>/assets/js/bulb-field.js?v=3.2"></script>
    <?php endif; ?>
    <?php if ($currentSlug === 'mfa-setup'): ?>
    <script src="<?= SITE_URL ?>/assets/js/vendor/qrcode.min.js"></script>
    <?php endif; ?>
    <?php if (!empty($pageJs)): ?>
    <script src="<?= SITE_URL ?>/assets/js/<?= $pageJs ?>?v=3.2"></script>
    <?php endif; ?>
</body>
</html>
