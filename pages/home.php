...
<section class="resolution section" id="services-preview">
    <div class="container">
        ...
        <div class="constellation reveal reveal-up" id="constellation" data-services-url="<?= SITE_URL ?>/services" role="img" aria-label="<?= e(t('home.constellation_aria_label')) ?>">
            <canvas class="constellation__canvas" id="constellation-canvas" aria-hidden="true"></canvas>
            ...
            foreach ($constellationLabels as $cl):
            ?>
            <div class="constellation__label constellation__label--<?= $cl['num'] ?>" data-service="<?= $cl['num'] ?>">
                <span class="constellation__num"><?= $cl['num'] ?></span>
                <div>
                    <h3 class="constellation__label-title constellation__label-title--<?= $cl['num'] ?>"><?= e(t('services.' . $cl['key'] . '_title')) ?></h3>
                    <p class="constellation__label-text"><?= e(t('services.' . $cl['key'] . '_short')) ?></p>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
