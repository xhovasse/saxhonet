<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/variables.css?v=2.7">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/reset.css?v=2.7">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/layout.css?v=2.7">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/components.css?v=2.7">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/animations.css?v=2.7">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/responsive.css?v=2.7">
    <?php if (!empty($pageCss)): ?>
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/<?= $pageCss ?>?v=2.7">
    <?php endif; ?>
