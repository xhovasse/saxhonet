<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/variables.css?v=3.1">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/reset.css?v=3.1">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/layout.css?v=3.1">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/components.css?v=3.1">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/animations.css?v=3.1">
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/responsive.css?v=3.1">
    <?php if (!empty($pageCss)): ?>
    <link rel="stylesheet" href="<?= SITE_URL ?>/assets/css/<?= $pageCss ?>?v=3.1">
    <?php endif; ?>
